...
Calendar.prototype.create = function (_par) {
	...
	var arVersion = navigator.appVersion.split("MSIE")
  	...
  	{
	  //div.innerHTML = '<iframe src="javascript:false" id="compareFrame" style=" position:absolute; border:0px;top:0px; left:0px;width:245px; visibility:inherit;height:172px; z-index:-1;filter="progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)";></iframe>';
	}
	...
	var hh = function (text, cs, navtype) {
		...
		if(navtype==-1)
		{
			cell.className += " nav_priv";
		}
		else if(navtype==1)
		{
			cell.className += " nav_next";
		}
	...
	if (this.isPopup) {
		...
		hh("&nbsp;", 1, 1).ttip = Calendar._TT["CLOSE"];
	}
//	row = Calendar.createElement("tr", thead);
...
function loadCalendar(id, format, showsTime, showsOtherMonths, selbtn) {
...
function showCalendar(id, format, showsTime, showsOtherMonths, selbtn) {
	...
	{
		loadCalendar(id, format, showsTime, showsOtherMonths, selbtn);
	}
	
	var cal_position=$('#calendar_list').css('bottom');
	...
	if(cal_position=='0px')
	{
		...
		$('#calendar_list').animate({bottom:'0px'},500);
	}
